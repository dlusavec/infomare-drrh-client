...
public class Start {
	...
	public static void main(String[] args) {
		 ...
		 */
		//Banke
		//BankManagementInterfaceClientImpl klijentB = new BankManagementInterfaceClientImpl();
		...
		//Rezervacije
		//ReservationManagementServiceClientImpl klijentR=new ReservationManagementServiceClientImpl();
		//klijentR.razmjenaRezervacija();
		//Ugovori
		//ContractManagementServiceClientImpl klijentC=new ContractManagementServiceClientImpl();
		//klijentC.razmjenaUgovora();
		//Narudzbenice
		//PurchaseOrderManagementServiceClientImpl klijentPO = new PurchaseOrderManagementServiceClientImpl();
		//klijentPO.razmjenaNarudzbenica();
		//Fakture
		//InvoiceManagementServiceClientImpl klijentI=new InvoiceManagementServiceClientImpl();
