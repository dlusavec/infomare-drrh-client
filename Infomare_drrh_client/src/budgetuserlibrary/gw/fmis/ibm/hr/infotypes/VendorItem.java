...
/**
 * <p>Java class for VendorItem complex type.
 * 
...
@XmlType(name = "VendorItem", namespace = "http://hr.ibm.fmis.gw.BudgetUserLibrary/infotypes/", propOrder = {
    ...
    "buFmisVendorId",
    "sapVendorId",
    "alternativeMasterVendorId",
    "alternativeBuFmisVendorId",
    "alternativeSapVendorId",
    "paymentReference",
    "description",
    "houseBank",
    "vendorBank",
...
public class VendorItem {
	...
	public void postaviVrijednosti(Invoicemsg invoiceMsg,
		...
		iban=StringUtils.trimToNull(invoiceMsg.getVendoiban());
